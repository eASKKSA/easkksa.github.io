...
const schedules = [
    {day: 'Segunda a Sexta', time: '20h30 - 21h30', level: 'Adultos (+12 anos)'},
    {day: 'Segunda a Sexta', time: '19h30 - 20h30', level: 'Crianças (-12 anos)'},
];
...
const Home: React.FC = () => {
    ...
    return (
        <>
            <Seo
                title="ASKKSA | Respeito e Disciplina"
                ...
                <div
                  ...
                  Associação Shotokan Kokusai Karaté Santo António
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <button
                                className="bg-[#a4262c] hover:bg-[#8b1e23] text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 focus:ring-4 focus:ring-[#a4262c]/50 shadow-lg">
                    ...
                    <div
                        className="absolute top-0 left-0 w-32 h-32 bg-[#a4262c]/20 rounded-full -translate-x-16 -translate-y-16"/>
                    <div
                        className="absolute bottom-0 right-0 w-48 h-48 bg-[#a4262c]/10 rounded-full translate-x-24 translate-y-24"/>
                </div>
            </AnimatedSection>
            ...
            <AnimatedSection>
                <div
                    className="bg-gradient-to-br from-[#a4262c] to-[#741b1f] rounded-3xl p-8 md:p-12 text-white shadow-2xl">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className={`text-xl mb-8 dark:text-gray-300 text-gray-600`}>
                                Venha conhecer nossa estrutura e metodologia.<br/>
                                A primeira aula é sempre <b>gratuita</b>!
                            </p>
